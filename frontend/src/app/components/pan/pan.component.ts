...
export class PanComponent implements OnInit {
    ...
    public getEventosGastoTotalCandidato(){
        this._consultaEventosService.getGastoTotalEventos(this.busquedaPAN, this.candidatoPresidente, '', '').subscribe(presidente => {
            this._consultaEventosService.getGastoTotalEventos(this.busquedaPAN, this.candidatoSenador, '', '').subscribe(senador => {
                this._consultaEventosService.getGastoTotalEventos(this.busquedaPAN, this.candidatoDiputado, '', '').subscribe(diputado => {
                    this._consultaEventosService.getGastoTotalEventos(this.busquedaPAN, this.candidatoGobernador, '', '').subscribe(gobernador => {
                        this._consultaEventosService.getGastoTotalEventos(this.busquedaPAN, this.candidatoAlcalde, '', '').subscribe(alcalde => {
                            let estructura = {
                                datasets: [{
    ...
    public getEventosEstadosGasto(){
        this._consultaEventosService.getEstadosEventos(this.busquedaPAN, this.candidatoPresidente, '', '').subscribe(res => {
            if(res){
    ...
    public getEventosGastoCategoria(){
        ...
        this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, 'estructura').subscribe(estructura => {
            this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, 'animacion').subscribe(animacion => {
                this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, 'transporte').subscribe(transporte => {
                    this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, 'produccion').subscribe(produccion => {
                        this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, 'espectacular').subscribe(espectacular => {
                            this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, 'utilitario').subscribe(utilitario => {
    ...
    public getEventosGastoSubcategoriaEstructura(){
        ...
        this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, categoria).subscribe(estructura => {
        let estruct = {
            datasets: [{
    ...
    public getEventosGastoSubcategoriaAnimacion(){
        ...
        this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, categoria).subscribe(animacion => {
            let estruct = {
                datasets: [{
    ...
    public getEventosGastoSubcategoriaTransporte(){
        ...
        this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, categoria).subscribe(transporte => {
            let estruct = {
                datasets: [{
    ...
    public getEventosGastoSubcategoriaProduccion(){ 
        ...
        this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, categoria).subscribe(produccion => {
            let estruct = {
                datasets: [{
    ...
    public getEventosGastoSubcategoriaEspectacular(){
        ...
        this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, categoria).subscribe(espectacular => {
            let estruct = {
                datasets: [{
    ...
    public getEventosGastoSubcategoriaUtilitario(){
        ...
        this._consultaEventosService.getGastoSubcategoria(this.busquedaPAN, this.candidatoPresidente, categoria).subscribe(utilitario => {
        let estruct = {
            datasets: [{
    ...
    public  getGastoTotalTierraCandidato() {
        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, '', '').subscribe(presidente => {
            this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoSenador, '', '').subscribe(senador => {
                this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoDiputado, '', '').subscribe(diputado => {
                    this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoGobernador, '', '').subscribe(gobernador => {
                        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoAlcalde, '','').subscribe(alcalde => {
                            const estructura = {
                                datasets: [{
                                    data: [ presidente, senador, diputado, gobernador, alcalde ],
    ...
    public getTierraGastoEstado() {
        this._consultaTierraService.getEstadosTierra(this.busquedaPAN, this.candidatoPresidente, '', '').subscribe(res => {
            if(res){
                let arr:Array<any> = this._graphicsService.sortGasto(res);
                const estructura = {
                    datasets: [{
    ...
    public getTierraGastoCategoria() {
        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, '', 'Movil', '').subscribe(movilPRI => {
            this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, '', 'Fija', '').subscribe(fijaPRI => {
                const estructura = {
                    labels: ['Móvil', 'Fija'],
                    datasets: [{
                        label: 'PRI',
    ...
    public getTierraGastoSubcategoriaFija(){
        ...
        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Espectaculares').subscribe(Espectaculares => {
            this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Bardas').subscribe(Bardas => {
                this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Lonas').subscribe(Lonas => {
                    this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Puentes').subscribe(Puentes => {
                        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Pendones').subscribe(Pendones => {
                            this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Kioscos').subscribe(Kioscos => {
                                this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Carteles').subscribe(Carteles => {
                                    this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Parabuses').subscribe(Parabuses => {
                                        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Mobiliario/EspacioPublico').subscribe(Mobiliario => {
                                            this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Volantes y Pegatinas').subscribe(Volantes => {
                                                this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Valla Impresa').subscribe(VallaI => {
                                                    this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Valla Digital').subscribe(VallaD => {
                                                        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Pantallas Fijas').subscribe(Pantallas => {
                                                            this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Propaganda en Columnas').subscribe(Propaganda => {
                                                                this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Buzones').subscribe(Buzones => {
                                                                    this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Cajas de Luz').subscribe(Cajas => {
                                                                        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Marquesinas').subscribe(Marquesinas => {
                                                                            this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Muebles Urbanos').subscribe(Muebles => {
                                                                                this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Espectaculares de Pantallas Digitales').subscribe(EspectacularesP => {
                                                                                    this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Mantas (Igual o Mayor a 12 MTS)').subscribe(Mantas12 => {
                                                                                        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Mantas (Menores a 12 MTS)').subscribe(MantasM12 => {
                                                                                            const estruct = {
                                                                                                datasets: [{
    ...
    public getTierraGastoSubcategoriaMovil(){
        let categoria = 'Movil';
        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Transporte Público(combis, micros, camiones)').subscribe(Transporte => {
            this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Vehículos Publicidad(pantallas o lonas)').subscribe(Vehiculos => {
                this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Particulares').subscribe(Particulares => {
                    this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Taxis').subscribe(Taxis => {
                        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Metro (dentro de vagones)').subscribe(Metro => {
                            this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Brigadas (reparten utilitarios,en cruceros pueden abrir lonas)').subscribe(Brigadas => {
                                this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Bicicletas/Bicitaxis/Mototaxis').subscribe(Bicicletas => {
                                    this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Perifoneo').subscribe(Perifoneo => {
                                        this._consultaTierraService.getGastoTotalTierra(this.busquedaPAN, this.candidatoPresidente, categoria, 'Pantallas Moviles').subscribe(Pantallas => {
                                            const estruct = {
                                                datasets: [{
